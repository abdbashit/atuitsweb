...
<div class="bio-container">
    <div class="bio-header">
        <img src="./images/Mr. Alhaj ZAKARIA ISMAIL MAHAMUD.PNG" alt="Profile Picture" class="profile-pic">
        <h1>Mr. Alhaj ZAKARIA ISMAIL</h1>
        <p>Associate Professor of Computer Science</p>
    </div>

    <div class="bio-content">
        <h2>Introduction</h2>
        <p>Dr. John Doe is an Associate Professor of Computer Science with over 15 years of experience in both academia and industry. He is passionate about teaching and research in the fields of artificial intelligence, machine learning, and data science.</p>
